...
def ask_transport(question):
    ...
    keywords_q1 = ["trains", "to", "stockholm", "how", "much"]

    matches_q1 = 0

    # How much is the monthly subscription for UL card?

    keywords_q2 = ["monthly", "subscription", "ul" "card", "how", "much"]

    matches_q2 = 0

    # How far is the Arlanda Airport?

    keywords_q3 = ["arlanda", "airport"]

    matches_q3 = 0

    # Buses to Polacksbacken

    keywords_q4 = ["buses", "bus", "polacksbacken", ""]

    matches_q4 = 0

    # Are there student discounts for transportation

    keywords_q5 = ["student", "discount", "transportation"]
